...
const STRINGS = {
  tr: {
    ...
    "brief.p2": "Not üç parçaya bölündü. Her bölümü bitirince bir not parçası ve bir kod kazanırsınız. Üç kod birleşince Final Dosyası açılır.",
  ...
  en: {
    ...
    "brief.p2": "The note was split into three pieces. When you finish each chapter you earn a piece of the note and a code. When the three codes are combined, the Final File opens.",
